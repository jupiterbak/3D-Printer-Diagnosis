...
var _gcodeInterpreter = require('./GCodeInterpreter.js');
...
var GCodeToolpath = function() {
    ...
    function GCodeToolpath(options) {
        var _this = this;

        _classCallCheck(this, GCodeToolpath);
        ...
        this.offsetG92 = function(pos) {
            return {
                ...
                e: pos.e + _this.g92offset.e,
                f: pos.f + _this.g92offset.f
            };
        };
        ...
        this.handlers = {
            ...
            'G0': function G0(params) {
                ...
                var v2 = {
                    ...
                    e: _this.translateE(params.E),
                    f: _this.translateF(params.F)
                };
                var targetPosition = { x: v2.x, y: v2.y, z: v2.z, e: v2.e, f: v2.f };

                _this.offsetAddLine(v1, v2);

                // Update position
                _this.setPosition(targetPosition.x, targetPosition.y, targetPosition.z, targetPosition.e, targetPosition.f);
            },
            // G1: Linear Move
            // Usage
    ...
    _createClass(GCodeToolpath, [{
        ...
        value: function setPosition() {
            ...
            if (_typeof(pos[0]) === 'object') {
                ...
                this.position.e = typeof e === 'number' ? y : this.position.e;
                this.position.z = typeof f === 'number' ? z : this.position.f;
            } else {
                var _x2 = pos[0],
                    _y = pos[1],
                    _z = pos[2],
                ...
                this.position.e = typeof _e === 'number' ? _e : this.position.e;
                this.position.f = typeof _f === 'number' ? _f : this.position.f;
            }
        }
    }, {
        key: 'translateX',
        ...
        key: 'translateE',
        value: function translateZ(e, relative) {
            if (e !== undefined) {
                e = this.isImperialUnits() ? in2mm(e) : e;
            }
            if (relative === undefined) {
                relative = this.isRelativeDistance();
            }
            return translatePosition(this.position.e, e, !!relative);
        }
    }, {
        key: 'translateF',
        value: function translateZ(f, relative) {
            if (f !== undefined) {
                f = this.isImperialUnits() ? in2mm(f) : f;
            }
            if (relative === undefined) {
                relative = this.isRelativeDistance();
            }
            return translatePosition(this.position.f, f, !!relative);
        }
    }, {
        key: 'translateI',
